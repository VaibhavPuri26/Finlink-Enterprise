...
export default function Profile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`https://finlink-enterprise.onrender.com/api/user/update/${currentUser._id}`, {
        method: "POST",
        headers: {
